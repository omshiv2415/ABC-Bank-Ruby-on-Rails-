...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { branchLocation: @branch.branchLocation, branchName: @branch.branchName, branchPostcode: @branch.branchPostcode }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { branchLocation: @branch.branchLocation, branchName: @branch.branchName, branchPostcode: @branch.branchPostcode }
    assert_redirected_to branch_path(assigns(:branch))
  end
